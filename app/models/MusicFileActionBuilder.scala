...
/**
  ...
  */
case class MusicFileControllerComponents @Inject()(postActionBuilder: PostActionBuilder,
...
/**
  ...
  */
class MusicFileBaseController @Inject()(pcc: MusicFileControllerComponents) extends BaseController with RequestMarkerContext {
